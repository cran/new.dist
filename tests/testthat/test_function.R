...
test_that("functions returns a  vector with the expected size", {
  ...
  expect_vector(ddLd1(1, theta=0.5), ptype = double(), size = 1)
  expect_vector(ddLd1(-1, theta=0.5), ptype = double(), size = 1)
  expect_vector(ddLd1(1, theta=0.5,log=T), ptype = double(), size = 1)
  expect_vector(pdLd1(1, theta=0.5), ptype = double(), size = 1)
  expect_vector(pdLd1(-1, theta=0.5), ptype = double(), size = 1)
  expect_vector(pdLd1(1, theta=0.5, lower.tail = F), ptype = double(), size = 1)
  expect_vector(pdLd1(1, theta=0.5, log.p = T), ptype = double(), size = 1)
  expect_vector(qdLd1(.1, theta=0.5), ptype = double(), size = 1)
  expect_vector(qdLd1(0.1, theta=0.5, lower.tail = F),
                ptype = double(), size = 1)
  expect_vector(rdLd1(20, theta=0.5), ptype = double(), size = 20)
  expect_vector(dmd(1, theta=0.5), ptype = double(), size = 1)
  expect_vector(dmd(-1, theta=0.5), ptype = double(), size = 1)
  expect_vector(dmd(1, theta=0.5, log=T), ptype = double(), size = 1)
  expect_vector(pmd(1, theta=0.5), ptype = double(), size = 1)
  expect_vector(pmd(-1, theta=0.5), ptype = double(), size = 1)
  expect_vector(pmd(1, theta=0.5, lower.tail = F), ptype = double(), size = 1)
  expect_vector(pmd(1, theta=0.5, log.p = T), ptype = double(), size = 1)
  expect_vector(qmd(.1, theta=0.5), ptype = double(), size = 1)
  expect_vector(qmd(.1, theta=0.5, lower.tail = F), ptype = double(), size = 1)
  expect_vector(rmd(20, theta=0.5), ptype = double(), size = 20)
  expect_vector(dkd(0.1, lambda=2, alpha=3), ptype = double(), size = 1)
  expect_vector(dkd(0.1, lambda=2, alpha=3, log = T),
                ptype = double(), size = 1)
  expect_vector(pkd(0.1, lambda=2, alpha=3), ptype = double(), size = 1)
  expect_vector(pkd(0.1, lambda=2, alpha=3, log.p = T),
                ptype = double(), size = 1)
  expect_vector(pkd(0.1, lambda=2, alpha=3, lower.tail = F),
                ptype = double(), size = 1)
  expect_vector(qkd(0.1, lambda=2, alpha=3), ptype = double(), size = 1)
  expect_vector(qkd(0.1, lambda=2, alpha=3, lower.tail = F),
                ptype = double(), size = 1)
  expect_vector(rkd(20, lambda=2,alpha=3), ptype = double(), size = 20)
  ...
  expect_vector(dLd(.5,theta=2), ptype = double(), size = 1)
  expect_vector(pLd(.5,theta=2), ptype = double(), size = 1)
  expect_vector(pLd(.5,theta=2,lower.tail=F), ptype = double(), size = 1)
  expect_vector(pLd(.5,theta=2,log.p=T), ptype = double(), size = 1)
  expect_vector(pLd(-5,theta=2,log.p=F), ptype = double(), size = 1)
  expect_vector(qLd(.5,theta=2), ptype = double(), size = 1)
  expect_vector(qLd(c(.5,.2),theta=c(2,3),lower.tail=F),
                ptype = double(), size = 2)
  expect_vector(rLd(20,theta=2), ptype = double(), size = 20)
  ...
  expect_vector(dRA(1,theta=2), ptype = double(), size = 1)
  expect_vector(dRA(-1,theta=2), ptype = double(), size = 1)
  expect_vector(dRA(1, theta=2, log = T), ptype = double(), size = 1)
  expect_vector(pRA(1, theta=2), ptype = double(), size = 1)
  expect_vector(pRA(1, theta=2, lower.tail = F), ptype = double(), size = 1)
  expect_vector(pRA(1, theta=2, log.p = T), ptype = double(), size = 1)
  expect_vector(pRA(-1, theta=2, log.p = T), ptype = double(), size = 1)
  expect_vector(qRA(.1, theta=2), ptype = double(), size = 1)
  expect_vector(qRA(.1, theta=2, lower.tail = F), ptype = double(), size = 1)
  expect_vector(rRA(20,theta=2), ptype = double(), size = 20)
  ...
  expect_vector(rpldd(20, alpha=2, beta=3, theta=4), ptype = double(),
                size = 20)
  expect_vector(ddLd2(-1, theta=5), ptype = double(), size = 1)
  expect_vector(ddLd2(-1, theta=5), ptype = double(), size = 1)
  expect_vector(ddLd2(1, theta=5, log=T), ptype = double(), size = 1)
  expect_vector(pdLd2(1, theta=5), ptype = double(), size = 1)
  expect_vector(pdLd2(-1, theta=5), ptype = double(), size = 1)
  expect_vector(pdLd2(-1, theta=5, log.p = T), ptype = double(), size = 1)
  expect_vector(pdLd2(-1, theta=5, log.p = F), ptype = double(), size = 1)
  expect_vector(pdLd2(-1, theta=5, log.p = T, lower.tail = F),
                ptype = double(), size = 1)
  expect_vector(pdLd2(-1, theta=5, log.p = F, lower.tail = T),
                ptype = double(), size = 1)
  expect_vector(pdLd2(-1, theta=5, log.p = F, lower.tail = F),
                ptype = double(), size = 1)
  expect_vector(pdLd2(-1, theta=5, log.p = T, lower.tail = T),
                ptype = double(), size = 1)
  expect_vector(pdLd2(-1, theta=5, lower.tail = F), ptype = double(), size = 1)
  expect_vector(pdLd2(-1, theta=5, log.p = T), ptype = double(), size = 1)
  expect_vector(pdLd2(-1, theta=5, lower.tail = F), ptype = double(), size = 1)
  expect_vector(pdLd2(-1, theta=5, lower.tail = T), ptype = double(), size = 1)
  expect_vector(pdLd2(1, theta=5), ptype = double(), size = 1)
  expect_vector(pdLd2(1, theta=5), ptype = double(), size = 1)
  expect_vector(pdLd2(1, theta=5, log.p = T), ptype = double(), size = 1)
  expect_vector(pdLd2(1, theta=5, log.p = F), ptype = double(), size = 1)
  ...
  expect_vector(pdLd2(1, theta=5, lower.tail = F), ptype = double(), size = 1)
  expect_vector(pdLd2(1, theta=5, lower.tail = T), ptype = double(), size = 1)
  expect_vector(pdLd2(0, theta=5, lower.tail = F), ptype = double(), size = 1)
  expect_vector(pdLd2(0, theta=5, log.p = T), ptype = double(), size = 1)
  expect_vector(pdLd2(0, theta=5, lower.tail = F), ptype = double(), size = 1)
  expect_vector(pdLd2(0, theta=5, lower.tail = T), ptype = double(), size = 1)
  expect_vector(pdLd2(.5,theta=2), ptype = double(), size = 1)
  expect_vector(pdLd2(.5,theta=2,lower.tail=F), ptype = double(), size = 1)
  expect_vector(pdLd2(.5,theta=2,log.p=T), ptype = double(), size = 1)
  expect_vector(pdLd2(-5,theta=2,log.p=F), ptype = double(), size = 1)
  expect_vector(qdLd2(.1, theta=5), ptype = double(), size = 1)
  expect_vector(qdLd2(.1, theta=5, lower.tail = F), ptype = double(), size = 1)
  expect_vector(rdLd2(20, theta=5), ptype = double(), size = 20)
})
